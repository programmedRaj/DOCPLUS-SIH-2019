...
<style type="text/css">		
	...
	<body>
							...
							<nav class="main-nav">
								<ul class="list-unstyled">
									...
									<li class="menu-item-has-children">
										<a href="#">Search</a>
										<ul>
											<li><a href="docsearch.php">Hospitals</a></li>
											<li><a href="#">Laboratories</a></li>
											<li><a href="medisearch.php">Medical insurance</a></li>
		...
		<!-- Hero Section -->
		<div class="section hero-section transparent" style="background-image: url('images/bg2.jpg');">
			<div class="inner">
				<div class="container">
					<div class="job-search-form">
						<h2>Find Labs nearby you..</h2>
						<form class="form-inline flex" action="getlab.php" method="get">
							
							<div class="form-group">							
								<input type="text" class="form-control" id="input-field-2" placeholder=" Enter pincode" autocomplete="off" required name="pin">
								
								<i class="ion-ios-location-outline"></i>
								<div class="result"></div>
							</div>
							<div class="form-group">							
								<input type="text2" class="form-control" id="input-field-1" placeholder="blood/urine/stool/xray/brain/eye ear/sonography" autocomplete="off" name="cat">
