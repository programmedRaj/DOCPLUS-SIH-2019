...
<head>
    ...
    <script>
        ...
        function getdiagnosis() {
            document.getElementById('hospbutton').disabled = false;
            yob = $('#yob').val();
...
<div class="jumbotron jumbotron-fluid">
    <div class="container"><center>
        <h1 class="roboto display-4"><b>Vdoc </b></h1>
        <p class="roboto">Feeling sick? Find out why!</p></center>
    </div>
...
<div class="container-fluid"><br>
        ...
        <div class="respond">
            ...
            <form class="form-inline padit" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
              <label for="pincode">Area Pincode:</label>
              <input class="form-control" style="margin-left: 10px;" type="number" name="pincode" id="pincode">
            </form>
            ...
            <form class="form-group padit" method="post" action="">
                ...
                <div style="text-align: center;margin-top: 50px">
                    ...
                    <input type="button" value="SELECT" class="btn btn-primary" onclick=getselectedsymps();setpin();>
        ...
        <div class="respond">
            ...
            <center><a onclick="redirectto();"><input id="hospbutton" type="button" value="FIND HOSPITALS" class="btn btn-success" disabled="true"></a></center><br>
            <script>
            function redirectto(){
                window.location.href="http://www.sharingofminds18.biz/mafia/search/getresults.php?docpin="+pincode+"";
                }
            </script>
</div> <br>
