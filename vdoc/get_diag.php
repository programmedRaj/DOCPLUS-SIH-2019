...
if(!empty($_POST["yob"])&&!empty($_POST["gen"])&&!empty($_POST["bloc"])&&!empty($_POST["bsloc"])&&!empty($_POST["symps"])) {
    ...
    for($i=0;$i<sizeof($darray);$i++){
        ...
        <tr>
           ...
           <!-- <td><a href="http://www.sharingofminds18.biz/sih/search/getresults.php?docpin=$pincode">Find Hospitals</a></td> -->
        </tr>
...
if (empty($darray)) {
  echo "<center><a href='../BOT/index.php'>talk with bot</a></center><br>";
}
