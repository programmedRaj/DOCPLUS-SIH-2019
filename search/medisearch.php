...
<style type="text/css">		
	...
	<body>
		...
		<!-- Hero Section -->
		<div class="section hero-section transparent" style="background-image: url('images/bg34.jpg');">
			<div class="inner">
				<div class="container">
					<div class="job-search-form">
						<h2 style="color:#191414;">Find best mediclaims</h2>
						<form class="form-inline flex" action="getclaims.php" method="get">
							
							<div class="form-group">							
								<input type="text" class="form-control" id="input-field-2" placeholder=" Enter price to find mediclaims" autocomplete="off" name="price">
