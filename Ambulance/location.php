			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" action="loginaction.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Number is required">
						<input class="input100" type="text" Placeholder="999-999-9999" name="number" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" >
						<span class="focus-input100"></span>
				<br>	</div>
					
					
					
						<input type="text" name="location" value="<?php echo "$r"  ;?>" hidden >
						<span class="focus-input100"></span>
				<br>
